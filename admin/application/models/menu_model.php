...
* @revised       null
* @Description   All the insert, retrive, update, orderby operation of menu, innermenu, listing of menu and inner menu, updat                 e checbox are done here.
* @Param String  null
...
class Menu_model extends CI_Model
{
	...
	return $query;
	 ...
	 function get_page_url($page_id){
         ...
         $this->db->select('url');
          return $this->db->get_where('pages',array('id'=>$page_id))->row()->url;
	...
	function delete_menu($id){
			$delete  = $this->db->delete('menu', array('id' => $id)); 
			return $delete;
	}
	...
	function update_checkbox($data,$id){
		...
		$check = $this->db->update('menu', $data,$id);
