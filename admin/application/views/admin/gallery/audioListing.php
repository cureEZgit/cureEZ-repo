        ...
        <section class="content">
            ...
            <div class="col-md-12">
             <div class="box-header with-border">
                      <h3 class="box-title">Audio listing</h3>
                      <div class="box-tools pull-right">
                       
                        <a  href="<?php echo site_url('admin/gallery/create_audio/'); ?>" class="btn btn-success" ><i class="fa fa-plus"></i></a>
                  ...
                  if($dt->file !=""){
                      $ado = base_url('upload/gallery/music/'.$dt->file);
                  }else if($dt->source != ""){
                    $ado = $dt->source;
                  }
                ...
                Your browser does not support the <code>audio</code> element.
                  ...
                  <?php } ?>
                          ...
                          <span class="users-list-date">
                              ...
                              <a class="btn btn-warning btn-flat"  href="<?php echo site_url('admin/gallery/edit_audio/'.$dt->id); ?>" ><i class="fa fa-edit"></i></a>
...
if(confirm("Are You Sure?")){
    ...
    $.post('<?php echo site_url('admin/gallery/delete_audio_gallery')?>',{id:id},function(resp){
        if(resp == 1){
          location.reload();
