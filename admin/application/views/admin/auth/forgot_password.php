...
<head>
        ...
        <title>CureEZ - Forgot Password</title>
                	...
                	<div class="loginbox">
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<p class="account-subtitle">Get Reset password link.</p>
								  <div class="col-12">
                                    <?php if ($message){?>    
								...
								<div class="text-center forgotpass"><a href="<?php echo base_url('admin/auth/login');?>">Login</a></div>
