...
$().ready(function() {
    ...
    <div id="content">
               ...
               <div class="row">
               <div class="col-lg-12">
                    <h2 class="page-header"><?php echo "Add Image";?></h2>
                </div>
            </div>
...
<form  id="signupForm" method="post" action="<?= site_url('admin/gallery/add_image').'/'.$gallery_id ;?>" enctype="multipart/form-data">
