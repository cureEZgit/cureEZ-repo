...
<div class="welcometext"><span class="dhanara"><a href="<?php echo $pg_img['menu_link']; ?>"><?php echo $pg_img['page_name']; ?> </a></span>  <span class="dhanara"> &nbsp;&nbsp; >> &nbsp;&nbsp; </span>  <span class="dhanara"><a href="#"><font color="#ff8686"><?php echo $pg_img['title']; ?></font></a></span></div>
...
<ul class="lb-album">
					<li>
						...
						<a style="text-decoration: none !important" href="<?= site_url('page/details').'/'.$gal['id'] ;?>">
