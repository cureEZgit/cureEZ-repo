...
(function(a){
    ...
    a.extend(a.jqx._jqxButton.prototype,{
        ...
        createInstance:function(c){
            ...
            this.addHandler(this.host,"mousedown",function(e){
                if(!b.disabled){
                    b.isPressed=true;
                    b.refresh()
                }
            ...
            this.addHandler(a(document),"mouseup.button"+this.element.id,function(e){
                if(!b.disabled){
                    b.isPressed=false;
                    b.refresh()
                }
            ...
            this.propertyChangeMap.roundedCorners=function(e,g,f,h){
                e.refresh()
            };
            ...
            this.propertyChangeMap.theme=function(e,g,f,h){
                e.host.removeClass();
                e.host.addClass(e.toThemeProperty("jqx-button"));
                e.host.addClass(e.toThemeProperty("jqx-widget"));
                if(!e.overrideTheme){
                    e.host.addClass(e.toThemeProperty(a.jqx.cssroundedcorners(e.roundedCorners)))
                }
                e.refresh()
            }
        },
        ...
        _removeHandlers:function(){
            ...
            this.removeHandler(a(document),"mouseup.button"+this.element.id)
        },
        destroy:function(){
