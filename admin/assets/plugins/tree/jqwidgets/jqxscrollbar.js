...
(function(a){
    ...
    a.extend(a.jqx._jqxScrollBar.prototype,{
        ...
        createInstance:function(c){
            ...
            this.propertyChangeMap.value=function(d,f,e,g){
                d.setPosition(g)
            };
            
            this.propertyChangeMap.theme=function(d,f,e,g){
                d.setTheme()
            };
            
            this.propertyChangeMap.max=function(d,f,e,g){
                if(e!=g){
                    d.setPosition(d.value);
                    d._arrange()
                }
            };
        
            this.propertyChangeMap.min=function(d,f,e,g){
                if(e!=g){
                    d.setPosition(d.value);
                    d._arrange()
                }
            ...
            this.propertyChangeMap.touchMode=function(d,f,e,g){
                if(e!=g){
                    d._updateTouchBehavior()
                }
            };
        ...
        _addHandlers:function(){
            var d=this;
            if(d.isTouchDevice){
                this.addHandler(this.btnThumb,"touchend",function(f){
                    var g=d.vertical?d.toThemeProperty("jqx-scrollbar-thumb-state-pressed"):d.toThemeProperty("jqx-scrollbar-thumb-state-pressed-horizontal");
                    var h=d.toThemeProperty("jqx-fill-state-pressed");
                    d.btnThumb.removeClass(g);
                    d.btnThumb.removeClass(h);
                    if(!d.disabled){
                        d.handlemouseup(d,f)
                    }
                });
                this.addHandler(this.btnThumb,"touchstart",function(f){
                    if(!d.disabled){
                        if(d.touchMode==true){
                            f.clientX=f.originalEvent.clientX;
                            f.clientY=f.originalEvent.clientY
                        }else{
                            var g=f;
                            if(g.originalEvent.touches&&g.originalEvent.touches.length){
                                f.clientX=g.originalEvent.touches[0].clientX;
                                f.clientY=g.originalEvent.touches[0].clientY
                            }
                        }
                        d.handlemousedown(f)
                    }
                });
                a.jqx.mobile.touchScroll(this.element,d.max,function(l,k,g,f,h){
                    if(d.host.css("visibility")=="visible"){
                        if(d.touchMode==true){
                            ...
                            var j=h;
                            if(j.originalEvent.touches&&j.originalEvent.touches.length){
                                h.clientX=j.originalEvent.touches[0].clientX;
                                h.clientY=j.originalEvent.touches[0].clientY
                            }
                        }
                        ...
                        d.btnThumb.addClass(i);
                        d.btnThumb.addClass(d.toThemeProperty("jqx-fill-state-pressed"));
                        d.handlemousemove(h)
                    }
                })
            }
            this.addHandler(this.btnUp,"click",function(f){
            ...
            this.addHandler(this.btnDown,"click",function(f){
            ...
            if(!this.isTouchDevice){
                ...
                this.addHandler(this.btnDown,"mouseup",function(f){
                ...
                this.addHandler(this.btnUp,"mouseup",function(f){
                ...
                this.addHandler(this.btnDown,"mousedown",function(f){
                    if(!d.btnDownInstance.base.disabled){
                ...
                this.addHandler(this.btnUp,"mousedown",function(f){
                    if(!d.btnUpInstance.base.disabled){
            ...
            this.addHandler(this.areaUp,c,function(f){
                if(!d.disabled){
                    d.setPosition(d.value-d.largestep);
                    return false
                }
            });
            this.addHandler(this.areaDown,c,function(f){
                if(!d.disabled){
                    d.setPosition(d.value+d.largestep);
                    return false
                }
            ...
            this.addHandler(this.btnThumb,"mousedown",function(f){
                if(!d.disabled){
                    d.handlemousedown(f)
                }
                return false
            });
            this.addHandler(this.btnThumb,"dragstart",function(f){
                return false
            });
            this.addHandler(a(document),"mouseup."+this.element.id,function(f){
                if(!d.disabled){
                    d.handlemouseup(d,f)
                }
            });
            if(!this.isTouchDevice){
                this.addHandler(a(document),"mousemove."+this.element.id,function(f){
                    if(!d.disabled){
                        d.handlemousemove(f)
                    }
                });
                this.addHandler(a(document),"mouseleave."+this.element.id,function(f){
                    if(!d.disabled){
                        d.handlemouseleave(f)
                    }
                });
                this.addHandler(a(document),"mouseenter."+this.element.id,function(f){
                    if(!d.disabled){
                        d.handlemouseenter(f)
                    }
                });
                if(!d.disabled){
        ...
        setTheme:function(){
            ...
            var h=this.btnDown;
            var e=this.btnThumb;
            var d=this.scrollWrap;
            var i=this.areaUp;
            var g=this.areaDown;
            var f=this.arrowUp;
            var b=this.arrowDown;
            ...
            h.addClass(this.toThemeProperty("jqx-scrollbar-button-state-normal"));
            c.addClass(this.toThemeProperty("jqx-scrollbar-button-state-normal"));
            if(this.vertical){
                f.addClass(this.toThemeProperty("icon-arrow-up"));
                b.addClass(this.toThemeProperty("icon-arrow-down"));
                e.addClass(this.toThemeProperty("jqx-scrollbar-thumb-state-normal"))
            }else{
                f.addClass(this.toThemeProperty("icon-arrow-left"));
                b.addClass(this.toThemeProperty("icon-arrow-right"));
                e.addClass(this.toThemeProperty("jqx-scrollbar-thumb-state-normal-horizontal"))
            }
            e.addClass(this.toThemeProperty("jqx-fill-state-normal"));
            if(this.disabled){
                d.addClass(this.toThemeProperty("jqx-fill-state-disabled"));
                d.removeClass(this.toThemeProperty("jqx-scrollbar-state-normal"))
            }else{
                d.addClass(this.toThemeProperty("jqx-scrollbar-state-normal"));
                d.removeClass(this.toThemeProperty("jqx-fill-state-disabled"))
            }
            if(c.jqxRepeatButton("disabled")!=this.disabled){
                c.jqxRepeatButton("disabled",this.disabled)
            }
            if(h.jqxRepeatButton("disabled")!=this.disabled){
                h.jqxRepeatButton("disabled",this.disabled)
            }
            if(e.jqxButton("disabled")!=this.disabled){
                e.jqxButton("disabled",this.disabled)
            }
            if(this.isTouchDevice&&this.touchModeStyle!=false){
                this.showButtons=false;
                e.addClass(this.toThemeProperty("jqx-scrollbar-thumb-state-normal-touch"))
            }
        },
        ...
        _positionelements:function(){
            ...
            var k=(m-i)/(this.max-this.min)*this.value;
            k=Math.round(k);
            if(this.vertical){
                var j=m-k-i;
                if(j<0){
        ...
        _arrange:function(){
            ...
            var m=this.btnDown;
            var v=this.btnThumb;
            var p=this.scrollWrap;
            if(this.roundedCorners=="all"){
                if(this.vertical){
                    c.jqxRepeatButton();
                    m.jqxRepeatButton();
                    var g=a.jqx.cssroundedcorners("top");
                    g=this.toThemeProperty(g);
                    c.addClass(g);
                    var r=a.jqx.cssroundedcorners("bottom");
                    r=this.toThemeProperty(r);
                    m.addClass(r)
                }else{
                    c.jqxRepeatButton();
                    m.jqxRepeatButton();
                    var l=a.jqx.cssroundedcorners("left");
                    l=this.toThemeProperty(l);
                    c.addClass(l);
                    var i=a.jqx.cssroundedcorners("right");
                    i=this.toThemeProperty(i);
                    m.addClass(i)
                }
            }else{
                var t=a.jqx.cssroundedcorners(this.roundedCorners);
                t=this.toThemeProperty(t);
                c.addClass(t);
                m.addClass(t)
            }
            v.jqxButton();
            ...
            var q=this.host.width();
            this._width=q;
            this._height=n;
            var b=(!this.vertical)?n:q;
            if(!this.showButtons){
                b=0
            }
            c.css({
            ...
            if(this.vertical){
                this._setElementPosition(m,0,n-m.outerHeight())
            }else{
                this._setElementPosition(m,q-m.outerWidth(),0)
            }
            var f=(!this.vertical)?q:n;
            this.scrollBarSize=f;
            var j=this._getThumbSize(f-2*b);
            j=Math.round(j);
            if(j<this.thumbMinSize){
                j=this.thumbMinSize
            }
            var o=false;
            if(this.isTouchDevice&&this.touchModeStyle!=false){
            ...
            if(!this.vertical){
                ...
                if(o){
                    ...
                    v.css("margin-top",(this.host.height()-this.thumbTouchSize)/2)
                }
            }else{
                v.css({
                    width:q+"px"
                ...
                if(o){
                    ...
                    v.css("margin-left",(this.host.width()-this.thumbTouchSize)/2)
                }
            }
            if(n==NaN||n<10){
                n=10
            ...
            b+=2;
            this.btnSize=b;
            var e=(this.vertical)?2*this.btnSize+v.outerHeight():2*this.btnSize+v.outerWidth();
            e=Math.round(e);
            this._btnAndThumbSize=e;
            var w=(f-e)/(this.max-this.min)*this.value;
            w=Math.round(w);
            if(isNaN(w)){
                w=0
            }
            if(this.vertical){
                ...
                var k=parseInt(this.host.height());
                v.css("visibility","inherit");
                if(k-3*parseInt(b)<0){
                    ...
                    if(k<e){
                        ...
                        if(this.host.css("visibility")=="visible"){
                            v.css("visibility","inherit")
                        }
                    }
                }
                this._setElementPosition(h,0,b);
                this._setElementPosition(v,0,b+w);
                this._setElementPosition(u,0,b+w+j)
            }else{
                h.css({
                    width:w+"px",
                    height:n+"px"
                ...
                var s=parseInt(this.host.width());
                v.css("visibility","inherit");
                if(s-3*parseInt(b)<0){
                    v.css("visibility","hidden")
                }else{
                ...
                this._setElementPosition(h,b,0);
                this._setElementPosition(v,b+w,0);
                this._setElementPosition(u,2+b+w+j,0)
            }
        }
    })
})(jQuery);